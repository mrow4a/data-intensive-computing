...
public class TopTen {
    ...
    public static class TopTenMapper extends Mapper<Object, Text, NullWritable, Text> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            String textMap = value.toString();
            Map<String, String> parsed = transformXmlToMap(textMap);
            ...
            if (userId != null && reputation != null) {
                ...
                repToRecordMap.put(Integer.parseInt(reputation), new Text(textMap));

                // If we have more than ten records, remove the one with the lowest reputation.
                if (repToRecordMap.size() > 10) {
                    // It is tree map, so sorted by default
    ...
    public static class TopTenReducer extends Reducer<NullWritable, Text, NullWritable, Text> {
        ...
        public void reduce(NullWritable key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
            ...
            // Please mind that first output will be in Combiner class, the other in Reducer
